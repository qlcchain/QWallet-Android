...
public class CubicBezierInterpolator implements Interpolator {
    ...
    public static final CubicBezierInterpolator EASE_OUT = new CubicBezierInterpolator(0, 0, 0.58, 1);
    public static final CubicBezierInterpolator EASE_OUT_QUINT = new CubicBezierInterpolator(.23, 1, 0.32, 1);
