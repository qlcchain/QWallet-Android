...
//		web3j = Web3jFactory.build(new HttpService(Environment.RPC_URL));
		try {
//			createWallet("11111111");
//			decryptWallet(keystore, "11111111");
//			testTransaction();
			testTokenTransaction(web3j, "0x7d5114d0EB75BEAA24344A8f8ADBDf1936525cC5", 
					"4f2723cb79e172f6cb3cd6275c35ee5baa3db45111dfccccbebbe6c4294fc690", 
					"0xB8c77482e45F1F44dE1745F52C74426C631bDD52", 
					"0x055a864a5f39f9eecd17e729e2cfc4fb6b12c19b", 0.01, 18);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private static void testTransaction() {
		...
		String to = "0x6c0f49aF552F2326DD851b68832730CB7b6C0DaF".toLowerCase(Locale.ENGLISH);
