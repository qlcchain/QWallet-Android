 ...
 */
public class LogPresenter implements LogContract.LogContractPresenter{
    ...
    @Inject
    public LogPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull LogContract.View view, LogActivity activity) {
        mView = view;
