 ...
 * @Description: presenter of JoinCommunityActivity
 * @date 2019/04/24 17:15:42
 */
public class JoinCommunityPresenter implements JoinCommunityContract.JoinCommunityContractPresenter{

    HttpAPIWrapper httpAPIWrapper;
    private final JoinCommunityContract.View mView;
    private CompositeDisposable mCompositeDisposable;
    private JoinCommunityActivity mActivity;

    @Inject
    public JoinCommunityPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull JoinCommunityContract.View view, JoinCommunityActivity activity) {
        mView = view;
