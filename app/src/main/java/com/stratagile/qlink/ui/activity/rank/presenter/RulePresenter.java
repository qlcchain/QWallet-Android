 ...
 * @Description: presenter of RuleActivity
 * @date 2018/08/03 09:44:05
 */
public class RulePresenter implements RuleContract.RuleContractPresenter{
    ...
    @Inject
    public RulePresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull RuleContract.View view, RuleActivity activity) {
        mView = view;
