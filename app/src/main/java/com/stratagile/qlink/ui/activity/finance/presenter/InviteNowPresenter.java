 ...
 * @Description: presenter of InviteNowActivity
 * @date 2019/04/28 16:32:00
 */
public class InviteNowPresenter implements InviteNowContract.InviteNowContractPresenter{

    HttpAPIWrapper httpAPIWrapper;
    private final InviteNowContract.View mView;
    private CompositeDisposable mCompositeDisposable;
    private InviteNowActivity mActivity;

    @Inject
    public InviteNowPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull InviteNowContract.View view, InviteNowActivity activity) {
        mView = view;
