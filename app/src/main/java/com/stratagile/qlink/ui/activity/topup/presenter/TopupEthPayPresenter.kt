 ...
 * @Description: presenter of TopupEthPayActivity
 * @date 2019/10/24 10:18:43
 */
class TopupEthPayPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: TopupEthPayContract.View) : TopupEthPayContract.TopupEthPayContractPresenter {
...
//                })
    ...
    private fun testTokenTransaction(web3j: Web3j, fromAddress: String, privateKey: String, contractAddress: String, toAddress: String, amount: String, decimals: Int, limit: Int, price: Int): String {
        ...
        val function = Function(
                "transfer",
                Arrays.asList(Address(toAddress), Uint256(baseToSubunit(amount, decimals))),
