...
public class TransactionRecordAdapter extends BaseQuickAdapter<Record.DataBean, BaseViewHolder> {
    ...
    public TransactionRecordAdapter(@Nullable List<Record.DataBean> data) {
