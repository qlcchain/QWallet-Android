 ...
 * @Description: presenter of ChangePasswordActivity
 * @date 2018/11/12 13:44:10
 */
public class ChangePasswordPresenter implements ChangePasswordContract.ChangePasswordContractPresenter{
    ...
    @Inject
    public ChangePasswordPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull ChangePasswordContract.View view, ChangePasswordActivity activity) {
        mView = view;
