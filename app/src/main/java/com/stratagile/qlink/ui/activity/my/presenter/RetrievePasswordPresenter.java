 ...
 * @Description: presenter of RetrievePasswordActivity
 * @date 2019/04/09 14:21:19
 */
public class RetrievePasswordPresenter implements RetrievePasswordContract.RetrievePasswordContractPresenter{
    ...
    @Inject
    public RetrievePasswordPresenter(@NonNull HttpAPIWrapper httpAPIWrapper, @NonNull RetrievePasswordContract.View view, RetrievePasswordActivity activity) {
        mView = view;
