...
public class JsInjectorClient {
    ...
    private String rpcUrl = ConstantValue.ethNodeUrl;
    ...
    String injectWeb3TokenInit(Context ctx, String view, String tokenContent, BigInteger tokenId)
    {
        ...
        initSrc = String.format(initSrc, tokenContent, walletAddress, ConstantValue.ethNodeUrl, chainId, tokenIdWrapperName);
