package com.stratagile.qlink.walletconnect.util
...
import com.stratagile.qlink.walletconnect.entity.InvalidHmacException
import com.stratagile.qlink.walletconnect.entity.WCEncryptionPayload
...
object WCCipher {
    ...
    fun decrypt(payload: WCEncryptionPayload, key: ByteArray): ByteArray {
        val data = payload.data.hexStringToByteArray1()
        val iv = payload.iv.hexStringToByteArray1()
