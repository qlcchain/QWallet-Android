...
import com.stratagile.qlink.LaunchVPN;
...
import com.stratagile.qlink.core.VpnStatus.ByteCountListener;
import com.stratagile.qlink.core.VpnStatus.StateListener;

import de.blinkt.openvpn.core.NativeUtils;

import static com.stratagile.qlink.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.stratagile.qlink.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static com.stratagile.qlink.core.NetworkSpace.ipAddress;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.stratagile.qlink.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.stratagile.qlink.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.stratagile.qlink.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.stratagile.qlink.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "com.stratagile.qlink.PAUSE_VPN";
    private static final String RESUME_VPN = "com.stratagile.qlink.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status) {
        ...
        if (mProfile != null)
            nbuilder.setContentTitle(getString(R.string.notifcation_title, "VPN"));
        else
    ...
    private int getIconByConnectionStatus(ConnectionStatus level) {
        ...
        switch (level) {
            case LEVEL_CONNECTED:
                return R.drawable.vpn_notification;
...
//                return android.R.drawable.ic_media_pause;
    ...
    synchronized void registerDeviceStateReceiver(OpenVPNManagement magnagement) {
        ...
        filter.addAction("com.stratagile.qlink.disconnectVpn");
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: de.stratagile.qlink.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        KLog.i("OpenVpnService的onStartCommand方法");
        Log.i("OpenVpnService", "OpenVpnService的onStartCommand方法");
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.stratagile.qlink.core.OpenVPNThreadv3");
    ...
    public void disconnectVpn(DisconnectVpn disconnectVpn) {
        KLog.i("断开vpn的请求");
        mManagement.stopVPN(false);
    }
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.stratagile.qlink.VPN_STATUS");
        vpnstatus.putExtra("status", level.toString());
        vpnstatus.putExtra("detailstatus", state);
        if (mProfile != null) {
            vpnstatus.putExtra("profileuuid", mProfile.getName());
        }
    ...
    public void onDisconnectVpnSuccess() {
        KLog.i("断开vpn成功，发送给mainactivity，更新ui");
        Intent vpnstatus = new Intent();
        vpnstatus.setAction(BroadCastAction.disconnectVpnSuccess);
