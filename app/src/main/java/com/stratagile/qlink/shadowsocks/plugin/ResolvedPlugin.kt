...
abstract class ResolvedPlugin(protected val resolveInfo: ResolveInfo) : Plugin() {
    ...
    override val label: CharSequence by lazy { resolveInfo.loadLabel(AppConfig.instance.packageManager) }
    override val icon: Drawable by lazy { resolveInfo.loadIcon(AppConfig.instance.packageManager) }
    ...
    override val trusted by lazy {
        AppConfig.instance.getPackageInfo(packageName).signaturesCompat.any(PluginManager.trustedSignatures::contains)
    }
}
