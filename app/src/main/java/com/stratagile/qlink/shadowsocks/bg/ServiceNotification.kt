...
import com.stratagile.qlink.shadowsocks.utils.broadcastReceiver
...
class ServiceNotification(private val service: BaseService.Interface, profileName: String,
    ...
    init {
        service as Context
        if (Build.VERSION.SDK_INT < 24) builder.addAction(R.drawable.ic_navigation_close, service.getString(R.string.stop), PendingIntent.getBroadcast(service, 0, Intent(Action.CLOSE), 0))
