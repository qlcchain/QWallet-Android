...
public class CustomItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<SideBean> mBeans;
    private static final int dividerHeight = 80;
    private Context mContext;
    private final Rect mBounds = new Rect();
    private String tagsStr;

    public void setDatas(List<SideBean> mBeans, String tagsStr) {
        this.mBeans = mBeans;
     ...
     */
    private void drawTitleBar(Canvas canvas, RecyclerView parent, View child, SideBean bean, int position) {
        final int left = 0;
...
//        ColorUtil.setPaintColor(mPaint, position);
        ...
        canvas.drawCircle(UIUtils.dip2px(42.5f, mContext), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(bean.getIndexTag(), UIUtils.dip2px(42.5f, mContext), bottom - dividerHeight / 3, mPaint);
    }
...
//        ColorUtil.setPaintColor(mPaint, tagsStr.indexOf(mBeans.get(position).getIndexTag()));
        ...
        canvas.drawCircle(UIUtils.dip2px(42.5f, mContext), bottom - dividerHeight / 2, 35, mPaint);
        mPaint.setColor(Color.WHITE);
        canvas.drawText(mBeans.get(position).getIndexTag(), UIUtils.dip2px(42.5f, mContext), bottom - dividerHeight / 3, mPaint);
    }
