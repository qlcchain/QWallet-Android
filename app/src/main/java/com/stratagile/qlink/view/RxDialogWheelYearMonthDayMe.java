...
public class RxDialogWheelYearMonthDayMe extends RxDialog {
    ...
    public RxDialogWheelYearMonthDayMe(Context context) {
        super(context);
    ...
    public RxDialogWheelYearMonthDayMe(Context context, int beginYear) {
        super(context);
        // TODO Auto-generated constructor stub
        this.context = context;
    ...
    public RxDialogWheelYearMonthDayMe(Context context, int beginYear, int endYear) {
        super(context);
        // TODO Auto-generated constructor stub
        this.context = context;
        this.beginYear = beginYear;
    ...
    public RxDialogWheelYearMonthDayMe(Context context, TextView tv_time) {
        super(context);
        // TODO Auto-generated constructor stub
        this.context = context;
        build();
    ...
    private void build() {
        ...
        //year
        year = (WheelView) dialogView1.findViewById(com.vondear.rxtools.R.id.wheelView_year);
        ...
        month = (WheelView) dialogView1
                .findViewById(com.vondear.rxtools.R.id.wheelView_month);
        ...
        //day
        day = (WheelView) dialogView1.findViewById(com.vondear.rxtools.R.id.wheelView_day);
        updateDays(year, month, day);
