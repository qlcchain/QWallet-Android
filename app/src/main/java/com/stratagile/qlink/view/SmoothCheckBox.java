...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, UIUtils.dip2px(0, getContext()));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = UIUtils.dip2px(DEF_DRAW_SIZE, getContext());
