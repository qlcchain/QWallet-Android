...
public class SegmentedGroup extends RadioGroup {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mCheckedBgColor = typedArray.getColor(
                    R.styleable.SegmentedGroup_sc_checked_bg_color,
                    mTintColor);
            mCheckedTextColor = typedArray.getColor(
                    R.styleable.SegmentedGroup_sc_checked_text_color,
                    getResources().getColor(android.R.color.white));

            mUnCheckedTintColor = typedArray.getColor(R.styleable.SegmentedGroup_unchecked_tint_color, getResources().getColor(R.color.radio_button_unselected_color));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    private void updateBackground(View view) {
        ...
        ((GradientDrawable) checkedDrawable).setColor(mCheckedBgColor);
        ((GradientDrawable) checkedDrawable).setStroke(mMarginDp, mCheckedBgColor);
