...
public class Account {
	...
	public String toString() {
		return "Account [accountName=" + accountName + ", privileged=" + privileged + ", lastCodeUpdate="
				+ lastCodeUpdate + ", created=" + created + ", ramQuota=" + ramQuota + ", netWeight=" + netWeight
				+ ", cpuWeight=" + cpuWeight + ", netLimit=" + netLimit + ", cpuLimit=" + cpuLimit + ", ramUsage="
				+ ramUsage + ", permissions=" + permissions + "]";
	}
