...
/* AssetsWarpper case that fails as leak_memory() leaks a dynamically allocated block. */
...
/* AssetsWarpper case that fails as buffer_overflow() corrupts an allocated block. */
...
/* AssetsWarpper case that fails as buffer_underflow() corrupts an allocated block. */
