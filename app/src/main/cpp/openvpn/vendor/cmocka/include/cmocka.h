...
#ifdef DOXYGEN
/**
 * @brief AssetsWarpper function overriding malloc.
 *
...
#ifdef DOXYGEN
/**
 * @brief AssetsWarpper function overriding calloc.
 *
...
#ifdef DOXYGEN
/**
 * @brief AssetsWarpper function overriding realloc which detects buffer overruns
 *        and memoery leaks.
 *
...
#ifdef DOXYGEN
/**
 * @brief AssetsWarpper function overriding free(3).
 *
