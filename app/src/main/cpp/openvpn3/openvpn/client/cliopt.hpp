...
#include <qlink/transport/client/extern/config.hpp>
#include <qlink/transport/client/extern/fw.hpp>
#endif
...
#include <qlink/tun/linux/client/tuncli.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <qlink/client/unix/cmdagent.hpp>
#endif
#elif defined(OPENVPN_PLATFORM_MAC) && !defined(OPENVPN_FORCE_TUN_NULL)
#include <qlink/tun/mac/client/tuncli.hpp>
#include <qlink/apple/maclife.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <qlink/client/unix/cmdagent.hpp>
#endif
#elif defined(OPENVPN_PLATFORM_WIN) && !defined(OPENVPN_FORCE_TUN_NULL)
#include <qlink/tun/win/client/tuncli.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <qlink/client/win/cmdagent.hpp>
#endif
#else
