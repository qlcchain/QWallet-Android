...
#include <qlink/openssl/util/init.hpp>

#include <qlink/openssl/crypto/api.hpp>
#include <qlink/openssl/ssl/sslctx.hpp>
#include <qlink/openssl/util/rand.hpp>

#endif

#if defined(USE_APPLE_SSL) || defined(USE_MBEDTLS_APPLE_HYBRID)
#include <qlink/applecrypto/crypto/api.hpp>
#include <qlink/applecrypto/ssl/sslctx.hpp>
#include <qlink/applecrypto/util/rand.hpp>
#endif

#if defined(USE_MBEDTLS) || defined(USE_MBEDTLS_SERVER)
#include <qlink/mbedtls/crypto/api.hpp>
#include <qlink/mbedtls/ssl/sslctx.hpp>
#include <qlink/mbedtls/util/rand.hpp>
